...
CREATE TABLE IF NOT EXISTS TUSERS (
    ...
    FKROLES_USE INT NOT NULL DEFAULT 2,
    PRIMARY KEY(ID_USE),
...
INSERT INTO TSETUPS (NAME_SET) VALUES ('Tareq setup');
INSERT INTO TSETUPS (NAME_SET) VALUES ('chad setup');
INSERT INTO TSETUPS (NAME_SET) VALUES ('momo setup');
INSERT INTO TSETUPS (NAME_SET) VALUES ('Tareq 2nd setup');
...
INSERT INTO TUSERS (EMAIL_USE, USERNAME_USE, PASSWD_USE, FKPICTURES_USE, FKROLES_USE)
    VALUES('chadreagon@gmail.com', 'chad', 'chad', 2, 1);
INSERT INTO TUSERS (EMAIL_USE, USERNAME_USE, PASSWD_USE, FKPICTURES_USE, FKROLES_USE)
    VALUES('social@tareqitos.com', 'tarek', 'tarek', 3, 1);
INSERT INTO TUSERS (EMAIL_USE, USERNAME_USE, PASSWD_USE, FKPICTURES_USE, FKROLES_USE)
    VALUES('mohamed.alibacha@gmail.com', 'momo', 'momo', 2, 1);
INSERT INTO TUSERS (EMAIL_USE, USERNAME_USE, PASSWD_USE, FKPICTURES_USE, FKROLES_USE)
    VALUES('user@gmail.com', 'user', 'user', 1, 2);
INSERT INTO TUSERS (EMAIL_USE, USERNAME_USE, PASSWD_USE, FKPICTURES_USE, FKROLES_USE)
    VALUES('admin@gmail.com', 'admin', 'admin', 1, 2);
...
INSERT INTO TCOMMENTS (TEXT_COMM, FKUSERS_COMM, FKGAMES_COMM) VALUES ('This game is boring', 2, 2);
...
INSERT INTO TUSE_GAM (FKUSERS_TUSEGAM, FKGAMES_TUSEGAM, NAME_TUSEGAM) VALUES (1, 1, 'Tareq GameList');
INSERT INTO TUSE_GAM (FKUSERS_TUSEGAM, FKGAMES_TUSEGAM, NAME_TUSEGAM) VALUES (2, 1, 'Chad Game List');
INSERT INTO TUSE_GAM (FKUSERS_TUSEGAM, FKGAMES_TUSEGAM, NAME_TUSEGAM) VALUES (3, 2, 'Momo Game List');
-- CHECK INFORMATION
SELECT * FROM TUSERS;